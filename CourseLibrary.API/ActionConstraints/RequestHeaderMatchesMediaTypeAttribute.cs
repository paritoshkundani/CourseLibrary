...
{
    // this attribute will help decide which Action to trigger based on the accept-type header
    // between CreateAuthor and CreateAuthorWithDateOfDeath
    ...
    public class RequestHeaderMatchesMediaTypeAttribute : Attribute, IActionConstraint
    {
            ...
            string mediaType, params string[] otherMediaTypes)
        {
            ...
            foreach(var otherMediaType in otherMediaTypes)
            {
                ...
                {
                    _mediaTypes.Add(otherMediaType);
                }
            }
        }
