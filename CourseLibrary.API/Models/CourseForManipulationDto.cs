...
namespace CourseLibrary.API.Models
{
    ...
    public abstract class CourseForManipulationDto //: IValidatableObject
    {
        ...
        // Creation did not require it (CourseForCreationDto) but Update Dto we'll require description
        // so mark it virtual to alow the Update to apply Required on it
